...
//
//import com.brain.gaming.sprites.Enemy1;
//import com.brain.gaming.sprites.Enemy2;
//import com.brain.gaming.sprites.Player;
...
//	}
	private void loadBackgroundImage() {
		try {
			backgroundImage = ImageIO.read(Board.class.getResource("bg1.jpg"));
		} catch (IOException e) {
...
//	}
	public void paintComponent(Graphics g) {
		...
		g.drawImage(backgroundImage,0,0,1500,920,null);
//		player.draw(g);
//                player.move();
//                printEnemies(g);
//                gameOver(g);
